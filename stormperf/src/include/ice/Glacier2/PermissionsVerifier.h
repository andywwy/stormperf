...
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_checkPermissions(const ::std::string& userId, const ::std::string& password, const ::IceInternal::Function<void (bool, const ::std::string&)>& response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_checkPermissions(userId, password, 0, response, exception, sent);
    }
    ::Ice::AsyncResultPtr
    begin_checkPermissions(const ::std::string& userId, const ::std::string& password, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_checkPermissions(userId, password, 0, ::Ice::newCallback(completed, sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_checkPermissions(const ::std::string& userId, const ::std::string& password, const ::Ice::Context& ctx, const ::IceInternal::Function<void (bool, const ::std::string&)>& response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_checkPermissions(userId, password, &ctx, response, exception, sent);
    }
    ::Ice::AsyncResultPtr
    begin_checkPermissions(const ::std::string& userId, const ::std::string& password, const ::Ice::Context& ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_checkPermissions(userId, password, &ctx, ::Ice::newCallback(completed, sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_checkPermissions(const ::std::string& userId, const ::std::string& password, const ::Ice::Context* ctx, const ::IceInternal::Function<void (bool, const ::std::string&)>& response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& exception, const ::IceInternal::Function<void (bool)>& sent)
    {
        ...
        return begin_checkPermissions(userId, password, ctx, new Cpp11CB(response, exception, sent));
    }
...
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_authorize(const ::Glacier2::SSLInfo& info, const ::IceInternal::Function<void (bool, const ::std::string&)>& response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_authorize(info, 0, response, exception, sent);
    }
    ::Ice::AsyncResultPtr
    begin_authorize(const ::Glacier2::SSLInfo& info, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_authorize(info, 0, ::Ice::newCallback(completed, sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_authorize(const ::Glacier2::SSLInfo& info, const ::Ice::Context& ctx, const ::IceInternal::Function<void (bool, const ::std::string&)>& response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_authorize(info, &ctx, response, exception, sent);
    }
    ::Ice::AsyncResultPtr
    begin_authorize(const ::Glacier2::SSLInfo& info, const ::Ice::Context& ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_authorize(info, &ctx, ::Ice::newCallback(completed, sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_authorize(const ::Glacier2::SSLInfo& info, const ::Ice::Context* ctx, const ::IceInternal::Function<void (bool, const ::std::string&)>& response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& exception, const ::IceInternal::Function<void (bool)>& sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
        ...
        return begin_authorize(info, ctx, new Cpp11CB(response, exception, sent));
    }
